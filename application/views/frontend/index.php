...
<section class="homapage-banner">
  <div class="wrap-slick1">
    <div class="slick1">
      <div class="item-slick1" style="background-image: url(<?=base_url()?>assets/frontend/images/banner/woman-banner.jpg);">
      ...
      <div class="item-slick1" style="background-image: url(<?=base_url()?>assets/frontend/images/banner/man-banner.jpg);">
        <div class="container h-full">
          <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
      ...
      <div class="item-slick1" style="background-image: url(<?=base_url()?>assets/frontend/images/banner/man-collection.jpg);">
          <div class="container h-full">
            <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
              ...
              <div class="layer-slick1 animated visible-false" data-appear="rotateInUpRight" data-delay="800">
                <h2 class="ltext-201 cl2 p-t-19 p-b-43 respon1">New 
                  <span class="d-block m-t-20">arrivals</span>
                </h2>
              </div>
