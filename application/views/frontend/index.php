...
<section class="section-slide">
  <div class="wrap-slick1">
    <div class="slick1">
      <div class="item-slick1" style="background-image: url(<?=base_url()?>assets/general/custom/banner/banner3-cropped.png);">
        <div class="container h-full">
          <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
            <div class="layer-slick1 animated visible-false" data-appear="fadeInDown" data-delay="0">
              <span class="ltext-101 cl2 respon2"> Women Collection 2018sss </span>
            </div>
      ...
      <div class="item-slick1" style="background-image: url(<?=base_url()?>assets/general/custom/banner/banner2-cropped.png);">
        <div class="container h-full">
          <div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
